...
class TestMeanMedianDifference(unittest.TestCase):
    ...
    def test_MMD_partyA(self):

        self.assertEqual(-1, mean_median_diff(self.district_plan, self.key_a))

    def test_MMD_partyB(self):

        self.assertEqual(1, mean_median_diff(self.district_plan, self.key_b))
